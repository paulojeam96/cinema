...
alter table ListaIngressos add FOREIGN KEY(id_ingresso) references ingresso(id);
...
insert into genero(nome) values('Ação'), ('Comédia'), ('Aventura'), ('Terror'), ('Adulto'), ('Suspense'), ('Musical'), ('Comedia-Romantica'), ('Documentario');
insert into distribuidora(nome) values('paramount'), ('disney'), ('marvel'), ('brasileirinhas'), ('paramuitos');
...
insert into filme (id_diretor, id_genero, id_distribuidora, nome, classificacao, ano, duracao, situacao, idioma) values(2, 2, 3, 'Busca Implacável', 14, 2012, 120, 'cartaz', 'ingles'), (3, 2, 3, 'Homem de Ferro', 16, 2010, 120, 'estreia', 'portugues'), (4, 3, 1, 'A Lenda Do Aluno Solitário', 10, 2015, 200, 'estreia', 'portugues'), (1, 4, 3, 'jogos mortais', 14, 2012, 120, 'cartaz', 'ingles');
